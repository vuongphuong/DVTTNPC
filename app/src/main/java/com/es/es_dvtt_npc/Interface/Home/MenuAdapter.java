...
public class MenuAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            holder = new Holder();
            view = inflater.inflate(R.layout.item_gridview_menu, null);
            holder.tvTitle = (TextView) view.findViewById(R.id.i_gridView_tvTitle);
            holder.ivIcon = (RoundedImageView) view.findViewById(R.id.i_gridView_ivIcon);
            view.setTag(holder);
        } else {
